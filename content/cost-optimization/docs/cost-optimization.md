...
![Node Decommissioning in action](../resources/images/node_decom.gif "Node Decommissioning in action")
...
![PVC Reuse in action](../resources/images/pvc_reuse.gif "PVC Reuse")
...
![CAS : Multiple NodeGroups Configuration](../resources/images/ca.png "CAS : Multiple NodeGroups Configuration")
...
![Karpenter : Node provisioning](../resources/images/karpenter.png "Karpenter : Node provisioning")
